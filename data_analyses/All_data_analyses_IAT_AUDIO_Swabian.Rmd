...
lmer (penal_RTs ~ charisma_lang_var*start_iat+ trialcount + age+ leadership_lang_var + (charisma_lang_var|bilendi_id) +  (start_iat|stimulus_ID), data = Four_Out_high_pop, REML = T, lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5))) -> model_pop_high
