...
#report(model1a)
#tab_model(model1a, file = "best_fit_model.doc")
```
...
#### General
Political ideology moderates how language variety mapped with charisma affects RTs dependig on block structure (start_iat)
