...
```
## 2.2. Impact language variety only
...
### 2.2.1. GLMs with age standardised RTs as DV
...
summary(model1b)
```
## 2.3. Language variety plus foci 
### 2.3.1. Age
...
```
## 2.5. Impact of language variety & SES
...
anova(model7)
```
### 2.5.6. Subset analyses SES with sum_variables
...
plot_pop_income
```
## 2.7. MC Social Desirebility SCale
